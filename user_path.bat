...
setx PATH %%BIN%%;%%CMAKE%%;%%MVN%%;%%ANT%%;%%YARN%%;%%CARGO%%;%%ECLIPSE%%;%%NODE%%;%%PYTHON2%%;%%PYTHON3%%;%PYTHON3_SCRIPTS%;%%CLANG%%;%%GNUPLOT%%;%vimpath%;%%MINGW_BIN%%;%%MINGW_USR_BIN%%;%%VIRTUALBOX_HOME%%;%%MIKTEX%%;%msbuildpath%
