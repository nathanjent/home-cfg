...
setx PATH %%BIN%%;%%CMAKE%%;%%CARGO%%;%%ECLIPSE%%;%%NODE%%;%%PYTHON3%%;%PYTHON3_SCRIPTS%;%%CLANG%%;%%VIM%%;%%GNUPLOT%%;%%MINGW_BIN%%;%%MINGW_USR_BIN%%;%%VIRTUALBOX_HOME%%;%msbuildpath%
